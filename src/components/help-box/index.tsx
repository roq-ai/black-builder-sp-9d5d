...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Entrepreneur'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Entrepreneur', 'Collaborator', 'Mentor'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Black Builder Space`;
  const tenantName = `Collaborator`;
