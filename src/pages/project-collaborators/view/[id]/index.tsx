...
import { getProjectCollaboratorById } from 'apiSdk/project-collaborators';
...
function ProjectCollaboratorViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Project Collaborator Detail View
          </Text>
          {hasAccess('project_collaborator', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/project-collaborators/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              ...
              {hasAccess('collaborator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/collaborators/view/${data?.collaborator?.id}`}>
